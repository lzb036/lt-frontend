...
const AutoDeletionManagementView = () => import('./components/crawler/AutoDeletionManagementView.vue')
...
const SystemMaintenanceManagementView = () => import('./components/crawler/SystemMaintenanceManagementView.vue')
...
const routes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      { path: 'ltJobs/imageCleanupJob', name: 'image-cleanup-jobs', component: SyncTaskView, props: { taskGroup: 'image_cleanup', title: '图片清理任务', eyebrow: 'Cleanup Jobs', emptyText: '暂无图片清理任务', actionLabel: '图片清理' }, meta: { title: '图片清理任务', permission: 'stores.manage' } },
      ...
      { path: 'ltShop/wjMerchantGoods', name: 'manual-pending-products', component: ProductWorkflowView, props: { status: 'pending', collectionSource: 'manual', title: '手动采集待审核', eyebrow: 'Rakuten Shop' }, meta: { title: '手动采集待审核', permission: 'products.manage' } },
      { path: 'ltShop/wjMerchantGoodsScheduled', name: 'scheduled-pending-products', component: ProductWorkflowView, props: { status: 'pending', collectionSource: 'scheduled', title: '定时采集待审核', eyebrow: 'Rakuten Shop' }, meta: { title: '定时采集待审核', permission: 'products.manage' } },
      ...
      { path: 'ltHj/wjMerchant', name: 'store-manager', component: StoreManagerView, meta: { title: '店铺管理', permission: 'stores.manage' } },
      ...
      { path: 'ai/title-optimization', name: 'ai-title-optimization', component: AiTitleSettingsView, meta: { title: '标题优化配置', permission: 'ai.manage' } },
